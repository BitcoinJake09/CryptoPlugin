...
WORKDIR /cryptoplugin
COPY . /cryptoplugin/
RUN mvn clean compile assembly:single
RUN cp /cryptoplugin/target/CryptoPlugin.jar /spigot/plugins/CryptoPlugin.jar
# Add the last version of NoCheatPlus
# ADD https://github.com/BitcoinJake09/CryptoPlugin/blob/master/Clearlag.jar /spigot/plugins/Clearlag.jar
WORKDIR /spigot
