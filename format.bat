...
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/cryptoplugin/cryptoplugin/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/cryptoplugin/cryptoplugin/commands/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/cryptoplugin/cryptoplugin/events/*
exit /b 0
